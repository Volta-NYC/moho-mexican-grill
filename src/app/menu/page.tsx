      ...
      <main className="bg-paper">
        <section className="relative overflow-hidden bg-ink px-4 pb-20 pt-36 text-cream sm:px-6 lg:px-8">
          ...
          <div className="relative mx-auto max-w-7xl">
            <span className="moho-green-tag mb-7">Halal and Zabiha certified</span>
          ...
          <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.7fr_1fr]">
            ...
            <div className="grid gap-5 md:grid-cols-3">
              {menuPreview.map((group, index) => (
                <article className={`reveal-on-scroll ${index === 0 ? "reveal-left" : index === 1 ? "reveal-soft reveal-delay-1" : "reveal-right reveal-delay-2"} bg-cream p-7 shadow-[8px_8px_0_#007a68]`} key={group.title} id={`${group.title.toLowerCase()}-menu`}>
